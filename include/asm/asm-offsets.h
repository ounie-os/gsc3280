...
#define TASK_MM 164 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 200 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STRUCT_SIZE 1072 /* sizeof(struct task_struct)	 # */
...
#define THREAD_REG16 448 /* offsetof(struct task_struct, thread.reg16)	 # */
#define THREAD_REG17 452 /* offsetof(struct task_struct, thread.reg17)	 # */
#define THREAD_REG18 456 /* offsetof(struct task_struct, thread.reg18)	 # */
#define THREAD_REG19 460 /* offsetof(struct task_struct, thread.reg19)	 # */
#define THREAD_REG20 464 /* offsetof(struct task_struct, thread.reg20)	 # */
#define THREAD_REG21 468 /* offsetof(struct task_struct, thread.reg21)	 # */
#define THREAD_REG22 472 /* offsetof(struct task_struct, thread.reg22)	 # */
#define THREAD_REG23 476 /* offsetof(struct task_struct, thread.reg23)	 # */
#define THREAD_REG29 480 /* offsetof(struct task_struct, thread.reg29)	 # */
#define THREAD_REG30 484 /* offsetof(struct task_struct, thread.reg30)	 # */
#define THREAD_REG31 488 /* offsetof(struct task_struct, thread.reg31)	 # */
#define THREAD_STATUS 492 /* offsetof(struct task_struct, thread.cp0_status)	 # */
#define THREAD_FPU 496 /* offsetof(struct task_struct, thread.fpu)	 # */
#define THREAD_BVADDR 812 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 816 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 820 /* offsetof(struct task_struct, thread.error_code)	 # */
#define THREAD_TRAMP 824 /* offsetof(struct task_struct, thread.irix_trampoline)	 # */
#define THREAD_OLDCTX 828 /* offsetof(struct task_struct, thread.irix_oldctx)	 # */

#define THREAD_FPR0 496 /* offsetof(struct task_struct, thread.fpu.fpr[0])	 # */
#define THREAD_FPR1 504 /* offsetof(struct task_struct, thread.fpu.fpr[1])	 # */
#define THREAD_FPR2 512 /* offsetof(struct task_struct, thread.fpu.fpr[2])	 # */
#define THREAD_FPR3 520 /* offsetof(struct task_struct, thread.fpu.fpr[3])	 # */
#define THREAD_FPR4 528 /* offsetof(struct task_struct, thread.fpu.fpr[4])	 # */
#define THREAD_FPR5 536 /* offsetof(struct task_struct, thread.fpu.fpr[5])	 # */
#define THREAD_FPR6 544 /* offsetof(struct task_struct, thread.fpu.fpr[6])	 # */
#define THREAD_FPR7 552 /* offsetof(struct task_struct, thread.fpu.fpr[7])	 # */
#define THREAD_FPR8 560 /* offsetof(struct task_struct, thread.fpu.fpr[8])	 # */
#define THREAD_FPR9 568 /* offsetof(struct task_struct, thread.fpu.fpr[9])	 # */
#define THREAD_FPR10 576 /* offsetof(struct task_struct, thread.fpu.fpr[10])	 # */
#define THREAD_FPR11 584 /* offsetof(struct task_struct, thread.fpu.fpr[11])	 # */
#define THREAD_FPR12 592 /* offsetof(struct task_struct, thread.fpu.fpr[12])	 # */
#define THREAD_FPR13 600 /* offsetof(struct task_struct, thread.fpu.fpr[13])	 # */
#define THREAD_FPR14 608 /* offsetof(struct task_struct, thread.fpu.fpr[14])	 # */
#define THREAD_FPR15 616 /* offsetof(struct task_struct, thread.fpu.fpr[15])	 # */
#define THREAD_FPR16 624 /* offsetof(struct task_struct, thread.fpu.fpr[16])	 # */
#define THREAD_FPR17 632 /* offsetof(struct task_struct, thread.fpu.fpr[17])	 # */
#define THREAD_FPR18 640 /* offsetof(struct task_struct, thread.fpu.fpr[18])	 # */
#define THREAD_FPR19 648 /* offsetof(struct task_struct, thread.fpu.fpr[19])	 # */
#define THREAD_FPR20 656 /* offsetof(struct task_struct, thread.fpu.fpr[20])	 # */
#define THREAD_FPR21 664 /* offsetof(struct task_struct, thread.fpu.fpr[21])	 # */
#define THREAD_FPR22 672 /* offsetof(struct task_struct, thread.fpu.fpr[22])	 # */
#define THREAD_FPR23 680 /* offsetof(struct task_struct, thread.fpu.fpr[23])	 # */
#define THREAD_FPR24 688 /* offsetof(struct task_struct, thread.fpu.fpr[24])	 # */
#define THREAD_FPR25 696 /* offsetof(struct task_struct, thread.fpu.fpr[25])	 # */
#define THREAD_FPR26 704 /* offsetof(struct task_struct, thread.fpu.fpr[26])	 # */
#define THREAD_FPR27 712 /* offsetof(struct task_struct, thread.fpu.fpr[27])	 # */
#define THREAD_FPR28 720 /* offsetof(struct task_struct, thread.fpu.fpr[28])	 # */
#define THREAD_FPR29 728 /* offsetof(struct task_struct, thread.fpu.fpr[29])	 # */
#define THREAD_FPR30 736 /* offsetof(struct task_struct, thread.fpu.fpr[30])	 # */
#define THREAD_FPR31 744 /* offsetof(struct task_struct, thread.fpu.fpr[31])	 # */
#define THREAD_FCR31 752 /* offsetof(struct task_struct, thread.fpu.fcr31)	 # */
...
#define MM_CONTEXT 336 /* offsetof(struct mm_struct, context)	 # */
